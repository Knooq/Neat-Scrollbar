...
of jQuery is used and ONLY when logged in.

This can be corrected by installing the latest version of jQuery Update
(version 7.x-2.x-dev), which works as expected.
